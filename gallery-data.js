/*
  ...
  ADD A REAL PIECE:
    1. Put the image in  img/gallery/  named:  YYYY-MM-DD-kebab-title.webp
       ...
       Images can sit in subfolders — just include the subfolder in  file: .
       We use:   2026-art/                 finished artwork
                 practice/<year>-q<n>/     warm-ups, numbered 001.webp, 002.webp…
                                           (a fresh 00N run each quarter, e.g.
                                            practice/2026-q2/001.webp)
...
const GALLERY = [
  ...
  { year:2026, title:"Happy Sun",         medium:"Digital · Krita", ratio:"wide",     mode:"art", file:"2026-art/2026-04-30-cartoony-sun.webp",          date:"2026-04-30" },
  ...
  { year:2026, title:"Practice 01", medium:"Digital · Krita", ratio:"wide", mode:"study", file:"practice/2026-q2/001.webp" },
  { year:2026, title:"Practice 02", medium:"Digital · Krita", ratio:"wide", mode:"study", file:"practice/2026-q2/002.webp" },
  { year:2026, title:"Practice 03", medium:"Digital · Krita", ratio:"wide", mode:"study", file:"practice/2026-q2/003.webp" },
  { year:2026, title:"Practice 04", medium:"Digital · Krita", ratio:"wide", mode:"study", file:"practice/2026-q2/004.webp" },
